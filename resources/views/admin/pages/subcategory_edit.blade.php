...
<div class="main-wrapper">
  ...
  <div class="page-wrapper">
    <div class="content container-fluid">
	  ...
	  <form method="post" enctype="multipart/form-data" action="{{ route('admin.subcategory.update', $sub_category->id) }}"/>
	  	@csrf
		...
		<div class="col-md-12 col-sm-6 col-xs-6 col-lg-12">
          <div class="form-group">
			 ...
			 <textarea class="form-control" rows="12" name="description" id="ajaxfilemanager" value="" tabindex="20" style="height:250px;">{{ $sub_category->description }}</textarea>
			</div>
        </div>
