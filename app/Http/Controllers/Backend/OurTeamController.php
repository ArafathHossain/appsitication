...
class OurTeamController extends Controller
{
  ...
  public function index()
	{
		$our_teams = our_team::orderBy('id', 'asc')->paginate(10);
	...
	public function update(Request $request, $id)
	{
		...
		$our_teams->position 		= $request->position;
		$our_teams->facebook 		= $request->facebook;
		$our_teams->twitter 		= $request->twitter;
		$our_teams->linkedin 		= $request->linkedin;
		$our_teams->googleplus 		= $request->googleplus;
		$our_teams->instagram 		= $request->instagram;
